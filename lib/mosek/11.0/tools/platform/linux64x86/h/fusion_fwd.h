...
namespace mosek
{
  namespace fusion
  {
    ...
    class p_Domain;
    class ExprParameter;
    class p_ExprParameter;
    class Param;
    class p_Param;
    class ExprMulParamScalarExpr;
    class p_ExprMulParamScalarExpr;
    class ExprMulParamScalar;
    class p_ExprMulParamScalar;
    class ExprMulParamDiagLeft;
    class p_ExprMulParamDiagLeft;
    class ExprMulParamDiagRight;
    class p_ExprMulParamDiagRight;
    class ExprDotParam;
    class p_ExprDotParam;
    class ExprMulParamElem;
    class p_ExprMulParamElem;
    class ExprMulParamRight;
    class p_ExprMulParamRight;
    class ExprMulParamLeft;
    class p_ExprMulParamLeft;
    class ParameterImpl;
    class p_ParameterImpl;
    class Parameter;
    class ExprOptimizeCode;
    class p_ExprOptimizeCode;
    class ExprCompress;
    ...
    class p_ExprRangeDomain;
    class ExprPSDDomain;
    class p_ExprPSDDomain;
    class ExprConicDomain;
    class p_ExprConicDomain;
    class ExprLinearDomain;
    class p_ExprLinearDomain;
    class ExprDomain;
...
namespace monty {
  ...
  template<> struct RefCounted_traits<::mosek::fusion::DeletionError> { typedef ::mosek::fusion::FusionRuntimeException parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::UpdateError> { typedef ::mosek::fusion::FusionRuntimeException parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::ExprScaleVecPSD> { typedef ::mosek::fusion::BaseExpression parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::ExprSumReduceEnd> { typedef ::mosek::fusion::BaseExpression parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::ExprCrossDot> { typedef ::mosek::fusion::BaseExpression parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::ExprRepeat> { typedef ::mosek::fusion::BaseExpression parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::ExprOptimizeCode> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::Parameter> { typedef ::mosek::fusion::Expression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprMulParamLeft> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprMulParamRight> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprMulParamElem> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprDotParam> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprMulParamDiagRight> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprMulParamDiagLeft> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprMulParamScalar> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprMulParamScalarExpr> { typedef ::mosek::fusion::BaseExpression parent; };
  template<> struct RefCounted_traits<::mosek::fusion::ExprParameter> { typedef ::mosek::fusion::BaseExpression parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::BoundInterfaceConstraint> { typedef ::mosek::fusion::SliceConstraint parent; };
  ...
  template<> struct RefCounted_traits<::mosek::fusion::BoundInterfaceVariable> { typedef ::mosek::fusion::SliceVariable parent; };
  template<> struct RefCounted_traits<::mosek::fusion::Model> { typedef ::mosek::fusion::BaseModel parent; };
  template<> struct RefCounted_traits<::mosek::fusion::SimpleTerm> { typedef ::mosek::fusion::Term parent; };
} // namespace monty 
#endif
